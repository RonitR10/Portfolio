...
export default function Resume() {
    ...
    return (
        <section className="bg-black rounded-4xl text-white min-h-screen py-12 bg-opacity-80 px-4 md:px-20 flex flex-col items-center" style={{
            ...
            <div className="backdrop-blur-sm rounded-lg p-4 flex flex-col items-center shadow-md overflow-auto ">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-14 mt-18">
                    <img src={cpp} className="bg-white h-37" alt="cpp" width={"150px"} height={"150px"} />
                    <img src={python} className="bg-white h-37" alt="python" width={"150px"} height={"150px"} />
                    ...
                    <img src={reactRouterDom} className="bg-white h-37" alt="reactRouterDom" width={"150px"} height={"150px"} />
                    <img src={jwt} className="bg-white h-37" alt="jwt" width={"150px"} height={"150px"} />
                    <img src={axios} className="bg-white h-37" alt="axios" width={"150px"} height={"150px"} />
                    <img src={cloudinary} className="bg-white h-37" alt="cloudinary" width={"150px"} height={"150px"} />
                    <img src={github} className="bg-white h-37" alt="github" width={"150px"} height={"150px"} />
                </div>
            </div>
        </section>
    );
